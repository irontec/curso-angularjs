...
RESTlist.prototype = {
    ...
    first: function () {
        return _.find(this.list, function (value, key) {
            return true;
        }, this);
    },
    ...
    save: function () {
        ...
        if (this.model && this.model.prototype.save) {
            store = _.reduce(this.list, function (store, value, key, collection) {
                store.list[key] = value.save();
                return store;
            }, store, this);
        }
...
RESTlist.open = function (config) {
    ...
    if (model) {
        _.forOwn(restlist.list, function (value, key, collection) {
